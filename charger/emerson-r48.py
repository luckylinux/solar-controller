...
if __name__ == "__main__":
    ...
    # Default to 52V instead of 57V
    # This will keep a safe operating voltage of 3.25V / cell, enough to continue operation, while allowing other chargers / MPPT / inverter to charge higher if there is PV energy available
    #config('can0')
    #set_voltage('can0', 52.0, True)
    #set_current('can0', 90.0, True)
    #config('can1')
    #set_voltage('can1', 52.0, True)
